...
public class JedisPoolExample2 {
  public static void main(String[] args) {
    ...
    firstClient.hset("info:sangmin", "이름", "상민");
    firstClient.hset("info:sangmin", "생일", "1998-05-18");

    final Jedis secondClient = pool.getResource();
    final Map<String, String> result = secondClient.hgetAll("info:sangmin");
